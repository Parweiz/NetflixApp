const faq = [
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        device, all for one fixed monthly fee. Plans range from 79 kr. to 129
        kr. a month. No extra costs, no contracts.
      </p>
    ),
  },
  {
  ...
  {
    id: 6,
    label: "Is Netflix good for children?",
    description: (
      <p>
        The Netflix Children's experience is included in your membership to give
        parents control while children enjoy family-friendly TV programmes and
        films in their own space.
        <br />
        Children's profiles come with PIN-protected parental controls that let
        you restrict the maturity rating of content children can watch and block
        specific titles you don’t want children to see.
      </p>
    ),
  },
];
